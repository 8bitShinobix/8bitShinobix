...
|---------|------|-----------|
| **Dream Launch** | SDE | Built LLM evaluation pipeline + multi-tenant SaaS with RBAC |
| **Chainge** | Full-Stack Mobile | End-to-end fitness social app with GPS tracking + real-time messaging |
| **Brackets** | SDE Intern | 60–70% DB read reduction, 30K+ daily requests at 99.9% uptime |
| **Kleem AI** | SDE | Conversational form builder + real-time voice agent |
| **Xtention Crew** | SDE Intern | Scalable dual-gateway payment system (Stripe + Razorpay) |

---

<p align="center">
  <b>Building things that work at scale. Let's talk.</b><br/>
  <a href="mailto:durgesh.work.x@gmail.com">durgesh.work.x@gmail.com</a>
</p>
